  ...
  <v-container grid-list-xl>
    <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      ...
      <v-flex xs12 sm12 md6 lg6 xl6>
        ...
        <form method="POST" action="https://formspree.io/xjvardzd">
          <v-text-field
            name="name"
            color="green"
  ...
  metaInfo: {
    ...
    meta: [
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        name: "description",
        content:
          "Saad's Contact Doboj Bosnia and Herzegovina Freelance Get in Touch ContactMe"
      },
      { charset: "utf-8" },
