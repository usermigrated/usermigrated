<template>
  <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      ...
      <v-card-text class="py-0">
        <v-timeline align-top dense>
          <v-timeline-item color="green" small>
            <v-layout pt-3>
              <v-flex xs4>
                <div class="caption font-weight-bold green--text">OCT 2022 -</div>
                <div class="caption font-weight-bold green--text">OCT 2024</div>
              </v-flex>
              <v-flex class="pl-2">
                <strong>Masters of Software Engineering</strong>
                <div class="caption mb-2">University of Hertfordshire</div>
              </v-flex>
            </v-layout>
          </v-timeline-item>
          <v-timeline-item color="green" small>
            <v-layout pt-3>
              <v-flex xs4>
                <div class="caption font-weight-bold green--text">OCT 2014 -</div>
                <div class="caption font-weight-bold green--text">AUG 2018</div>
              </v-flex>
              <v-flex class="pl-2">
                <strong>Bachelors of Science In Computer Sciences</strong>
                <div class="caption mb-2">Pak-AIMS - The Institute of Management Sciences</div>
              </v-flex>
            </v-layout>
          </v-timeline-item>
          ...
          <v-timeline-item color="green" small>
            <v-layout pt-3>
              <v-flex xs4>
                <div class="caption font-weight-bold green--text">SEP 2012 -</div>
                <div class="caption font-weight-bold green--text">APR 2014</div>
              </v-flex>
              <v-flex class="pl-2">
                <strong>FSC</strong>
                <div class="caption mb-2">Punjab Group of Colleges</div>
              </v-flex>
            </v-layout>
          </v-timeline-item>
        </v-timeline>
          ...
          <v-timeline-item color="green" small>
            <v-layout pt-3>
              ...
              <v-flex class="pl-2">
                ...
                <div class="caption mb-2">BearPlex</div>
              </v-flex>
            </v-layout>
          </v-timeline-item>
          ...
          <v-timeline-item color="green" small>
            <v-layout pt-3>
              ...
              <v-flex class="pl-2">
                ...
                <div class="caption mb-2">PetSaal Techologies</div>
              </v-flex>
            </v-layout>
          </v-timeline-item>
    ...
    <v-layout row justify-center align-center wrap class="mt-4 pt-2">
      ...
      <div class="mt-4 pt-2">
        <v-btn
          href="https://docs.google.com/document/d/1m4IKa2mcIB8re--hv1DG0zBb36G71voZ/view"
          target="_blank"
          color="green"
          dark
          large
...
export default {
  metaInfo: {
    ...
    meta: [
      ...
      { charset: "utf-8" },
      { property: "og:title", content: "Saad' Space" },
      { property: "og:site_name", content: "Saad' Space" },
      { property: "og:type", content: "website" },
      { property: "og:url", content: "http://usermigrated.com/" },
      {
        property: "og:image",
